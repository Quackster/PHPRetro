            ...
            <?php } ?>
                <div class="rounded rounded-blue">
                    ...
                    <fieldset id="installer-fieldset">
						...
						<?php 
						$db->query("UPDATE ".PREFIX."settings SET values '".$lang->loc['settings.site_closed.values']."' WHERE id = 'site_closed' LIMIT 1");
						$db->query("INSERT INTO `".PREFIX."settings` (id,`value`,label,description,`type`,`values`,page,`order`,category) VALUES ('site_highload','100','".$lang->loc['settings.site_highload']."','".$lang->loc['settings.site_highload.desc']."','textbox',null,'site','11','".$lang->loc['settings.category.traffic']."');");
